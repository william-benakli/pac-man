/* Maze generator copied by Shan Michel */
...
int main(int argc, char *argv[]) {
	...
	printf("Maze copied by Shan Michel\n");
	if (argc != 3 && argc != 4) {
...
// Merci Joe Wingbermuehle pour avoir partafgé son code!
// Pour cree le laby : ./exe <hauteur> <largeur>
// Pour résoudre le laby : ./exe <hauteur> <largeur> s
